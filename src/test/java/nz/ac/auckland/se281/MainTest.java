...
public class MainTest {
  ...
  //     assertDoesNotContain("Cannot create a new profile. First unload the profile for Tom.",
  // true);
  ...
  //     assertContains("Car Policy (Subaru Impreza, Sum Insured: $55000, Premium: $5580 ->
  // $5580)");
  //   }
  ...
  //     assertContains("Car Policy (Subaru Impreza, Sum Insured: $55000, Premium: $8250 ->
  // $7425)");
  //   }
  ...
  //     assertContains(
  //         "Home Policy (20 Symonds Street, Sum Insured: $1000000, Premium: $20000 -> $18000)");
  //     assertContains("Car Policy (Subaru Impreza, Sum Insured: $55000, Premium: $5500 ->
  // $4950)");
  //     assertContains("Car Policy (Subaru Impreza, Sum Insured: $55000, Premium: $8250 ->
  // $8250)");
  //   }
  ...
  //     assertContains("Car Policy (Subaru Forester, Sum Insured: $55000, Premium: $8250 ->
  // $7425)");
  ...
  //     runCommands(
  //         CREATE_PROFILE, "Jenny", 24, CREATE_PROFILE, "Jane", 43, LOAD_PROFILE, "Jane",
  // PRINT_DB);
  //     assertContains("Database has 2 profiles:");
  //     assertContains("1: Jenny, 24, 0 policies for a total of $0");
  ...
  //     runCommands(
  //         CREATE_PROFILE, "Jenny", 24, POLICY_HOME, options("1000000", "20 Symonds Street",
  // "yes"));
  //     assertContains("Need to load a profile in order to create a policy.");
  //     assertDoesNotContain("New home policy created", true);
  //   }
  ...
  //     assertContains("Home Policy (18 This Way, Sum Insured: $1000000, Premium: $10000 ->
  // $9000)");
  //   }
  ...
  //     assertContains("Home Policy (20 Garden Street, Sum Insured: $10000, Premium: $100 ->
  // $80)");
  //   }
  ...
  //     assertContains("Car Policy (Subaru Imperza, Sum Insured: $100000, Premium: $10080 ->
  // $9072)");
  ...
  //     assertContains("Car Policy (Honda NSX, Sum Insured: $1000000, Premium: $100000 ->
  // $100000)");
  //   }
  ...
  //     runCommands(
  //         unpack(CREATE_SOME_CLIENTS, LOAD_PROFILE, "TOM", CREATE_PROFILE, "tOBy", "28",
  // PRINT_DB));
